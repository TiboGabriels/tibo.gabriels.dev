...
draft: false
summary: 'In October 2021 I had the awesome opportunity to visit the datacenter of UGent.
...
<div className="grid grid-cols-2 sd:grid-cols-1">
    <div>
        <p>
    ...
    <div className="">
        <img className="w-full" alt="datacenter networking" src="/static/images/datacentre-networking.jpg"/>
    </div>
